...
- **HTTP API** — `POST /v1/evaluate`, agent + policy CRUD, decision reads, `/v1/keys` (issue/rotate/revoke), `/v1/approvers`, `/v1/approvals`, `/v1/settlements` + `/v1/reconciliation`. Zod-validated 400s, not 500s.
